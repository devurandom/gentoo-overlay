...
IUSE="clang debug doc libcxx +system-llvm +system-rust"
...
DEPEND="${RDEPEND}
	...
	system-rust? ( >=sys-devel/rust-${STAGE0_VERSION} )
"
...
src_configure() {
	...
	"${ECONF_SOURCE:-.}"/configure \
		...
		$(use_enable system-rust local-rust) \
...
src_compile() {
	...
	cp -r "${WORKDIR}/${stage0}"/rustc/* "${triplet}"/stage0/ || die
	emake VERBOSE=1
}
