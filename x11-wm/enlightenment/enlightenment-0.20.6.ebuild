...
if [[ ${PV} == *9999 ]] ; then
	...
	SRC_URI="https://download.enlightenment.org/rel/apps/${PN}/${MY_P}.tar.xz
             https://git.enlightenment.org/core/enlightenment.git/plain/src/modules/wl_weekeyboard/themes/default/default_600.edj?h=v${PV} -> ${P}-src_modules_wl_weekeyboard_themes_default_default_600.edj"
	EKEY_STATE="snap"
fi
...
src_prepare() {
	...
	cp ${DISTDIR}/${P}-src_modules_wl_weekeyboard_themes_default_default_600.edj src/modules/wl_weekeyboard/themes/default/default_600.edj || die
